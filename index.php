...
<div class="achievement">
    ...
    <div class="ach">
      ...
      <i class="fa fa-user" style="font-size:30px!important;"></i>
            ...
            <div class="ac1">
               <i class="fa fa-clock-o" style="font-size:30px!important;"></i>
                <h3>Duration:</h3>
                <p> 18 months </p>
            </div>
            ...
            <div class="ac1">
          <i class="fa fa-graduation-cap" style="font-size:30px!important;"></i>
                <h3>Faculty:</h3>
...
<br><div>
 ...
 <button class="enquireNowBtn" style="color: white; background-color: black;  border: none;">Know More <i class="fa fa-caret-down" style="color:#fff;"></i></button>
</div></div>
  </div>
</section>
...
<div class="b2-info">
    <div class="b1">
        <img src="assets/img/Layer-36.png">
    </div>

    <div class="b1">
         <img src="assets/img/Layer-37.png">
