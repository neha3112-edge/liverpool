...
<!-- <div class="multicolor-border"></div> -->
    ...
    <div class="footer-section">
            <div class="footer-column"><br>
                <A href="https://liverpool.distanceeducationschool.in/"><img src="assets/img/logo-ljmu-69721a8a14fa3.webp" alt="logo-img" width="50%"/></a><br><br>
...
<!-- <button class="enquireNowBtn">Enquire Now</button> -->
            ...
            <div class="footer-column">
                <h2>MBA Specialization</h2>
               <br>
				      <p>MSC in Data Science<br>
                      <p>MSC in Machine Learning & Artificial Intelligence<br>
            </div>
            <div class="footer-column">
                <h2>QUICK LINKS</h2><br>
				<p><a href="#about" style="text-decoration:none;">About</a></p>
				<p><a href="#courses_offered" style="text-decoration:none;">Courses</a></p>
