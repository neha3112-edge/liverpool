...
<!-- <button class="enquireNowBtn">Enquire Now</button> -->
            ...
            <div class="footer-column">
               ...
               <br>
				      <p>MBA in Business Analytics<br>
                      <p>MBA in Finance<br>
                      <p>MBA in Marketing<br>
                      <p>MBA in Leadership<br>
                      <p>MBA in Human Resouce Management<br>
                      <p>MBA in Operations and Supply chain Management<br>
            </div>
            <div class="footer-column">
